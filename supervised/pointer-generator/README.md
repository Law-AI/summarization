...
```
python run_summarization.py --mode=train --data_path=finished_files/chunked/train_* --vocab_path=finished_files/vocab --log_root=results/log --exp_name=myexperiment
```
